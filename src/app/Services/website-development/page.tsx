...
const page = () => {
  return (
    <div className="mt-24 flex flex-col justify-center items-center">
      ...
      <div className="w-screen mt-12 md:mt-0 flex flex-col justify-center items-center bg-black rounded-b-4xl shadow-[0_0_100px_rgba(236,19,19,0.2)] translate-y-10 z-10">
        <WeProvide
